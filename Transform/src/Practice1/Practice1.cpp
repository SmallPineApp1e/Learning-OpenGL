...
int main()
{
    ...
    // 编译顶点着色器和片段着色器
    Shader shader("shader/practice1/triangle.vert", "shader/practice1/triangle.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 旋转后模型坐标的x，y轴也被更改了，逆时针旋转90度后，x+指向原来的y+，y+指向原来的x-
        transformMatrix = glm::rotate(transformMatrix, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        transformMatrix = glm::translate(transformMatrix, glm::vec3(-0.5f, 0.0f, 0.0f));
